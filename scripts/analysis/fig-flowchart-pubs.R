...
pubs_2010_2020 [label = '@@5']
# NODES BLANK
node [label = '', width = 0.01, height = 0.01, style = invis]
rank = same
# EDGES INCLUSION
edge [minlen = 1]
pubs_all -> pubs_doi -> pubs_deduped -> pubs_resolved -> pubs_2010_2020
# EDGES BLANK
...
# NODES EXCLUSION
pubs_doi_ex [label = '@@6']
pubs_deduped_ex [label = '@@7']
pubs_resolved_ex [label = '@@8']
pubs_2010_2020_ex [label = '@@9']
}
# EDGES EXCLUSION
blank_1 -> pubs_doi_ex
blank_2 -> pubs_deduped_ex
blank_3 -> pubs_resolved_ex
blank_4 -> pubs_2010_2020_ex
}
# LABELS
[1]: label_pubs_all
[2]: label_pubs_doi
...
[5]: label_pubs_2010_2020
[6]: label_pubs_doi_ex
[7]: label_pubs_deduped_ex
[8]: label_pubs_resolved_ex
[9]: label_pubs_2010_2020_ex
")
